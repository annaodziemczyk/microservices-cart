        ...
        .then(() => {
                ...
                const start = async () => {
                    ...
                    try {
                        ...
                        await fastify.listen(3003, '0.0.0.0', function (err, address) {
                            if (err) {
...
//     c.forEach(function (productInCart) {
//         if(productInCart.productID==obj.productID){
//             productInCart.quantity = parseInt(productInCart.quantity, 10)+1;
...
//     console.log("delete ");
//     var c = cart["" + req.params.custId.toString()];
//
//     cart["" + req.params.custId.toString()] = c.filter(function (productInCart) {
//         return productInCart.productID!=req.params.id.toString();
//     });
//
//     res.status(201);
//     res.send(' ');
